...
<%--
 ...
 --%>
    ...
    <%-- a 링크 --%>
    <a href="ex08.jsp">ex08.jsp페이지로 이동(파라미터없음)</a><br><br>
    <a href="ex08.jsp?name=일지매&age=18">ex08.jsp페이지로 이동(파라미터있음)</a><br>
    <hr>
    
    <button onclick="send_go()">ex08.jsp페이지로 이동(파라미터없음)</a></button><br>
    <button onclick="send_go2()">ex08.jsp페이지로 이동(파라미터있음)</a></button><br>
