...
<body>
	...
	<%--
		...
		JSP : 구성
			...
			2. 스크립트요소 : HTML 안에서 자바코드를 사용할 있도록 만든 요소들
				1) 선언부(<%! 내용 %>) : 변수 선언이나 메소드 선언을 할 때 사용
				2) 스크립트리스트(<% 내용 %> : 자바 코드를 코딩할 때 사용
				3) 표현식(<%= 내용 %> 변수값이나 메소드의 결과값을 출력할 때 사용
				
				**주의 사항 : 스크립트요소들은 겹쳐서 사용하면안된다.
				
			1. 지시어 : <%@ page %>, <%@ table%>, <%@ include%>
				가. page 지시어	: 보통 해당 문서의 맨 앞에 나온다
								  형재 jsp 페이지에 대한 정보를 제고
