...
<!-- 
	...
	pageContext 객체는 JSP 기본 내장 객체로 JSP 페이지에 대한 1:1로 연결된 객체로 JSP 페이지당 하나의 
	pageContext 객체가 생성된다.
	...
	** 속성을 이용해서 데이터를 저장 및 호출하는 내장 객체들
	...
	생명주기 : pageContext < request < session < application
	         ...
	         session : 해당 브라우저가 종료되면 저장 정보도 사라진다.
	         		   (예외적으로 시간을 지정 가능하다._은행 로그인등 일정 시간 지나면 로그아웃 되는 것등)
 ...
 -->
	...
	<%-- 데이터 호출(나중에는 JSTL이나 EL를 사용해서 호출) --%>
