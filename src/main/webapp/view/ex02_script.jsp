...
<body>
<%--
	스크립트요소 : HTML 안에서 자바코드를 사용할 있도록 만든 요소들
				1) 선언부(<%! 내용 %>) : 변수 선언이나 메소드 선언을 할 때 사용
				2) 스크립트리스트(<% 내용 %> : 자바 코드를 코딩할 때 사용
				3) 표현식(<%= 내용 %> 변수값이나 메소드의 결과값을 출력할 때 사용(나중에 EL이나 JSTL로 변경)
				
				**주의 사항 : 스크립트요소들은 겹쳐서 사용하면 안된다.
 --%>
